...
For example, `\\d users` describes the users table, showing columns, types, and indexes. Lastly, to improve output,you can set the output format to 'auto' with `\\x auto`, which dynamically adjusts based on the terminal size.
